...
const Reviews = () => {
    return (
        <div >
            <h1 className='text-center mt-16 mb-8 text-4xl font-bold'><span className='text-6xl text-primary'>100+</span> Happy Customers <small className='text-center text-sm'>and still counting....</small></h1>
